...
from config import get_resource  # type: ignore[import]
_NIST_PATH    = Path(get_resource("config/nist.json"))
_APT_PATH     = Path(get_resource("data/apt_profiles.json"))
_GRAPH_PATH   = Path(get_resource("data/attack_graph.json"))
